...
* Android 12 and higher require certain modifications to boot & play videos. More info on [GSI Fixes](./GSI%20Fixes/).
* The headphone jack doesn't work properly on GSIs older than TrebleDroid 13.
